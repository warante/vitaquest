...
**Contexto:** VitaQuest era una app Next.js full-stack con PostgreSQL en Railway. El usuario quería desplegarla en GitHub Pages como PWA instalable en Android, con datos locales en el dispositivo (sin servidor).
...
**Consecuencias:**
- Se eliminó: Next.js, PostgreSQL, Drizzle, API routes, auth, Railway, offline queue.
